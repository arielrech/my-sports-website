...
import sportLogo from '../../../assets/logos/rhythmic_gymnastics_logo.png';

const Rgymnastics2025EChJu = () => {
  ...
  return (
    <TournamentPageTemplate 
      tournamentId='Rgymnastics2025EChJu'
      sportLogo={sportLogo}
...
export default Rgymnastics2025EChJu;
