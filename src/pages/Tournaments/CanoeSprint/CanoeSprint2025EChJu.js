...
import sportLogo from '../../../assets/logos/canoe_sprint_logo.png';

const CanoeSprint2025EChJu = () => {
  ...
  return (
    <TournamentPageTemplate 
      tournamentId='CanoeSprint2025EChJu'
      sportLogo={sportLogo}
...
export default CanoeSprint2025EChJu;
