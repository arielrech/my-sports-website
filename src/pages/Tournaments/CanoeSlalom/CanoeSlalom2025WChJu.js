...
import sportLogo from '../../../assets/logos/canoe_slalom_logo.png';

const CanoeSlalom2025WChJu = () => {
  ...
  return (
    <TournamentPageTemplate 
      tournamentId='CanoeSlalom2025WChJu'
      sportLogo={sportLogo}
...
export default CanoeSlalom2025WChJu;
