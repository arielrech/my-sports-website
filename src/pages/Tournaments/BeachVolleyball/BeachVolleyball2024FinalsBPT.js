...
import sportLogo from '../../../assets/logos/beach_volleyball_logo.png';

const BeachVolleyball2024FinalsBPT = () => {
  ...
  return (
    <TournamentPageTemplate 
      tournamentId='BeachVolleyball2024FinalsBPT'
      sportLogo={sportLogo}
...
export default BeachVolleyball2024FinalsBPT;
