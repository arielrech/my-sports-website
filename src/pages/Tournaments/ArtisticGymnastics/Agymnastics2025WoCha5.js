...
import sportLogo from '../../../assets/logos/artistic_gymnastics_logo.png';

const Agymnastics2025WoCha5 = () => {
  ...
  return (
    <TournamentPageTemplate 
      tournamentId='Agymnastics2025WoCha5'
      sportLogo={sportLogo}
...
export default Agymnastics2025WoCha5;
