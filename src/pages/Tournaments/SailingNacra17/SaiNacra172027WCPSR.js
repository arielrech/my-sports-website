...
import sportLogo from '../../../assets/logos/sailing_nacra17_logo.png';

const SaiNacra172027WCPSR = () => {
  ...
  return (
    <TournamentPageTemplate 
      tournamentId='SaiNacra172027WCPSR'
      sportLogo={sportLogo}
...
export default SaiNacra172027WCPSR;
