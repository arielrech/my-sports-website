...
import sportLogo from '../../../assets/logos/rugby_seven_logo.png';

const RugbySevens2025SVNSe3 = () => {
  ...
  return (
    <TournamentPageTemplate 
      tournamentId='RugbySevens2025SVNSe3'
      sportLogo={sportLogo}
...
export default RugbySevens2025SVNSe3;
