...
import sportLogo from '../../../assets/logos/basketball_logo.png';

const Basketball2025WChWU19 = () => {
  ...
  return (
    <TournamentPageTemplate 
      tournamentId='Basketball2025WChWU19'
      sportLogo={sportLogo}
...
export default Basketball2025WChWU19;
