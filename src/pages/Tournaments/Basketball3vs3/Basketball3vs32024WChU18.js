...
import sportLogo from '../../../assets/logos/basketball3vs3_logo.png';

const Basketball3vs32024WChU18 = () => {
  ...
  return (
    <TournamentPageTemplate 
      tournamentId='Basketball3vs32024WChU18'
      sportLogo={sportLogo}
...
export default Basketball3vs32024WChU18;
